...
#define GPIOA_BASE_ADDRESS (volatile uint32_t*)0x40020000
#define GPIOB_BASE_ADDRESS (volatile uint32_t*)0x40020400
#define GPIOC_BASE_ADDRESS (volatile uint32_t*)0x40020800
...
#define GPIOC_OSPEEDR  ((volatile uint32_t *)(GPIOC_BASE_ADDRESS + GPIO_OSPEEDR_OFFSET))
/*****************************************************************************************************************/
/*****************************************   GPIO_PUPDR **************************************************/
